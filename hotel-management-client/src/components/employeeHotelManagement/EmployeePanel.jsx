...
function EmployeePanel({ activeTab, setActiveTab, hotelInfo, locationIconUrl, phoneIconUrl, emailIconUrl, hotelIconUrl }) {
    return (
        <div className="hotel-management-sidebar">
            ...
            <div className="hotel-management-info">
                ...
                <p className="info-role">
                    ...
                    <span className="value">{hotelInfo?.userRole || 'Сотрудник'}</span>
                </p>
